...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="w-[104%] flex xl:flex-row flex-col justify-center min-h-screen 
      max-container gap-10"
    >
      <div className="relative flex xl:w-2/5 flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        <p className="text-xl font-montserrat text-coral-red">
          Our new Summer Collections
        </p>
